            ...
            <div className="max-w-8xl mx-auto px-3 sm:px-5 lg:px-8 mr-26 ml-26">
                <div className="flex items-center justify-between h-16 w-full">
                    ...
                    <div className="flex flex-1 space-x-4">
                        <a href="#" className="text-slate-500 px-4 py-2 hover:underline hover:underline-offset-6 hover:text-blue-200">Strona Główna</a>
                    ...
                    <div>
                        <button className="px-4 py-2 text-slate-900 bg-gray-100 hover:bg-blue-400 rounded-xl mr-3">Zaloguj się</button>
                        <button className="px-5 py-2 text-white bg-blue-600 hover:bg-blue-400 rounded-xl">Zarejestruj się</button>
                    </div>
                </div>
            </div>
        </nav>
